...
class CreateCourseFormComponent(BaseComponent):
    def __init__(self, page: Page, identifier: str):
        ...
        self.title_input = page.get_by_test_id(f'{identifier}-title-input').locator('input')
        self.estimated_time_input = page.get_by_test_id(f'{identifier}-estimated-time-input').locator('input')
        self.description_textarea = page.get_by_test_id(f'{identifier}-description-input').locator('textarea').first
        self.max_score_input = page.get_by_test_id(f'{identifier}-max-score-input').locator('input')
        self.min_score_input = page.get_by_test_id(f'{identifier}-min-score-input').locator('input')
