...
class CreateCourseFormComponent(BaseComponent):
    def __init__(self, page: Page, identifier: str):
        ...
        self.estimated_time_input = Input(page, f'{identifier}-estimated-time-input', 'Estimated time')
    ...
    @allure.step('Fill in course form')
    ...
    @allure.step('Check course form has correct values')
